...
CREATE TABLE `gameScore` (
  `GamePlayID` varchar(12) NOT NULL,
  `username` varchar(12) NOT NULL,
  `Score` int(11) DEFAULT NULL,
  `xcoordinate` int(11) DEFAULT NULL,
  `ycoordinate` int(11) DEFAULT NULL,
  `colour` varchar(25) DEFAULT NULL,
  PRIMARY KEY (`GamePlayID`,`username`),
  KEY `username` (`username`),
  CONSTRAINT `gamescore_ibfk_1` FOREIGN KEY (`GamePlayID`) REFERENCES `gamedata` (`GamePlayID`),
  CONSTRAINT `gamescore_ibfk_2` FOREIGN KEY (`username`) REFERENCES `user` (`username`)
...
-- Dump completed on 2019-11-21 22:40:56
